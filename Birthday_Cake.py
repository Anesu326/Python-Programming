...
def write_name_inside_circle(text_color, x, y):
    ...
    my_turtle_cursor.write("Anesu", font=("sans-serif", 26, "bold"))
...
#draw_stick("#E4E6EB", "#E4E6EB", 0, y_coordinate - 60)

#Drawing a circle on top of stick
#draw_circle_on_top_of_stick("#E4E6EB", "#FFFDD0", 100, y_coordinate + 235, 120)
...
#Writing Birthday inside of our circle
write_name_inside_circle("#000000", -80, y_coordinate + 140)
